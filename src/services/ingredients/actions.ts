...
export const loadIngredients = () => (dispatch: Dispatch) => {
  dispatch({
...
export const increaseIngredientCounter = (item: TBurgerIngredient) => ({
  type: INCREASE_INGREDIENT_COUNTER,
  payload: { item },
})

export const decreaseIngredientCounter = (item: TBurgerIngredient) => ({
